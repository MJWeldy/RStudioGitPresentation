...
author: "M Weldy and McKenna Marshall"
date: "`r Sys.Date()`"
output:
...
Below is the work log for the Oregon Coast Range multispecies multi-strata small mammal abundance project. It should contain summaries and headings of daily work activity to track project activity. 
...
# 9/3/2020 MW Project Github Initialization 
